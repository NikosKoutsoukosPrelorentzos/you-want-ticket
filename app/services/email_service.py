...
class EmailService:
    ...
    @staticmethod
    def send_event_cancel_notification(email: EmailStr, event_uuid: str, event_name: str):
        """Send notification email about event cancel."""
        changes_html = ""
        full_html = f"""
            <!DOCTYPE html>
            <html>
        ...
        params: resend.Emails.SendParams = {
            "from": "Tickets <onboarding@resend.dev>",
            "to": "nikoskoutsoukosprelorentzos@gmail.com",
            "subject": f"Event Cancel: {event_name}",
            "html": full_html
        }
